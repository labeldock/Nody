...
/** @define {boolean} */
var __GCC__IE_NODE_CONSTRUCTOR_AS_ACTIVX__ = false;
/** @define {boolean} */
...
/** @define {boolean} */
var __GCC__EXPORT_QUERY_SELECTOR_SHIM__ = false;
/** @define {boolean} */
var __GCC__EXPORT_GET_ELEMENTS_BY_CLASS_NAME_SHIM__ = true;
/** @define {(string|boolean)} */
var __GCC__GLOBAL_QUERY_SELECTOR_ALL_EXPORT__ = 'termiSelectorAll';
/** @define {(string|boolean)} */
var __GCC__GLOBAL_QUERY_SELECTOR_EXPORT__ = 'termiSelector';
/** @define {(string|boolean)} */
var __GCC__GLOBAL_MATCHES_SELECTOR_EXPORT__ = 'termiMatches';
/** @define {(string|boolean)} */
